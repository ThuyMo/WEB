...
Một điểm thú vị, bạn có "hô biến" OPPO A5 (2020) thành một cục pin dự phòng và sạc cho thiết bị khác thông qua cáp kết nối OTG.' ),
	(2,'2019-12-22','Thiết kế mặt lưng bóng bẩy sang trọng
...
Thiết bị có một tính năng khá thú vị đó là nghe đài FM không cần cắm tai nghe.' ),
	(3,'2019-12-22','iPhone 11 chúng ta sẽ có tới hai camera ở mặt sau.
...
Camera trước cũng có một tính năng thông minh, khi bạn xoay ngang điện thoại nó sẽ tự kích hoạt chế độ selfie góc rộng để bạn có thể chụp với nhiều người hơn.' ),
	(4,'2020-12-24','Màn hình chiếc điện thoại Vivo U10 có kích thước 6.35 inch độ phân giải HD+ trên tấm nền IPS LCD độ sáng cao, cho góc nhìn tốt, màu sắc trung tính.
...
Ngoài ra máy có hỗ trợ cảm biến vân tay ở mặt lưng. ' ),
	(5,'2019-12-25','Camera "bá đạo" trong phân khúc
...
Bảo mật bằng mật khẩu hoặc dấu vân tay của người dùng.' ),
	(6,'2019-12-25','Hiệu năng "đè bẹp" mọi đối thủ
...
iOS 13 mới trên iPhone 11 Pro Max
...
Bộ 3 camera hoàn toàn mới trên chiếc iPhone 11 Pro Max.
Và quả thực camera chính là điểm nâng cấp đáng giá nhất trên chiếc iPhone 11 Pro Max.
...
Ngoài ra trên chiếc iPhone này còn có thêm chế độ chụp đêm Night Mode giúp cải thiện rõ rệt chất lượng chụp ảnh trong điều kiện thiếu sáng của những chiếc iPhone.
...
Khả năng quay video trên iPhone từ trước tới nay vẫn được đánh giá rất cao và năm nay Apple nâng cấp lên độ phân giải 4K 60fps.
...
Apple công bố chiếc iPhone mới này sẽ cho thời gian dùng pin nhiều hơn 5 tiếng so với iPhone Xs Max nhưng thực tế con số này còn tốt hơn thế.
...
Vẫn còn nhiều cải tiến mà bạn nên biết
...
Máy có thể chịu được độ sâu lên tới 4m.' ),
	(7,'2019-12-26','Thiết kế sang trọng, quyến rũ
...
Máy có hỗ trợ công nghệ sạc nhanh nên chỉ 30 phút sạc đầy 54% pin và chỉ cần 1 giờ 20 phút để sạc đầy 100%. Ngoài ra máy cũng được trang bị sạc không dây 12W cũng như tính năng chia sẻ năng lượng sạc ngược không dây cho thiết bị khác.' ),
	(8,'2019-12-26','Camera là điểm nhấn trên Huawei P30 Pro với camera chính SuperSpectrum độ phân giải 40 MP.
...
Công nghệ sạc ngược không dây cho tai nghe, bàn chải hoặc điện thoại khác của P30 Pro mang đến sự tiện dụng và linh hoạt cho người dùng.' ),
	(9,'2019-12-26','Thiết kế của những chiếc máy BlackBerry luôn được người dùng đánh giá cao bởi chất doanh nhân của máy.
...
Laptop Asus VivoBook có thể sử dụng liên tục trong khoảng 3 - 4 tiếng nếu bạn sử dụng các tác vụ cơ bản như soạn thảo văn bản, lướt web, nghe nhạc, ...' ),
	(10,'2019-12-27','Máy sở hữu ngoại hình rất thanh lịch với hai sắc màu trắng và đen, phù hợp với cả những bạn trẻ hoặc người dùng trung niên hơn.
...
Máy cũng sẽ hỗ trợ công nghệ sạc nhanh để tiết kiệm thời gian sạc tối đa cho người dùng.' ),
	(11,'2019-12-27','Nokia 7.2 là một chiếc smartphone rất đáng chú ý trong những tháng cuối năm 2019 với thiết kế thời thượng, hệ điều hành mượt mà và cụm camera chất lượng.' ),
	(12,'2019-12-27','Samsung Galaxy A30 64GB là một chiếc máy khá hấp dẫn, dành cho các bạn yêu thích thương hiệu Samsung, muốn sở hữu một sản phẩm có nhiều tính năng hấp dẫn mà không cần phải bỏ ra nhiều tiền.
...
Mang trong mình một viên pin có dung lượng 4000 mAh giúp Samsung Galaxy A30 đáp ứng khá trọn vẹn với các nhu cầu giải trí cơ bản trong hơn một ngày.' ),
	(13,'2019-12-27','OPPO F11 gây ấn tượng với người dùng bởi thiết kế màn hình tràn viền hình giọt nước và camera sau khủng đến 48 MP.
...
Cung cấp sức mạnh cho F11 là con chip MediaTek Helio P70 8 nhân, bộ nhớ RAM lên tới 6 GB, ROM 64 GB.' ),
	(14,'2019-12-28','OPPO K3 là một chiếc smartphone tầm trung với khá nhiều tính năng cao cấp như màn hình không "tai thỏ" hay cảm biến vân tay bên trong màn hình.
...
OPPO K3 còn có viên pin dung lượng lớn 3765 mAh với tiêu chuẩn sạc nhanh VOOC 3.0, chỉ cần hơn 1 giờ để sạc đầy điện thoại nên cung cấp một thời lượng sử dụng rất dài.' ),
	(15,'2019-12-28','Nếu yêu thích hãng điện thoại BlackBerry và muốn sở hữu một chiếc smartphone Android với bàn phìm vật lý độc đáo, có lẽ BlackBerry KEYone 3GB/32GB là sự lựa chọn hàng đầu của bạn hiện nay.
...
Điểm thú vị trên BlackBerry KEYone chính là cảm biến vân tay một chạm được đặt ngay trên phím cứng Space (kế bên phím sym ở giữa hàng cuối trên bàn phím) rất tiện lợi.' ),
	(16,'2019-12-28','Đến hẹn lại lên, năm nay Apple giới thiệu tới người dùng thế hệ tiếp theo với 3 phiên bản, trong đó có cái tên iPhone Xs 64 GB với những nâng cấp mạnh mẽ về phần cứng đến hiệu năng, màn hình cùng hàng loạt các trang bị cao cấp khác. 
...
iPhone XS sở hữu hệ thống âm thanh 2 chiều cực kì tuyệt vời được Apple tinh chỉnh mang lại dải âm rộng và chi tiết hơn.' ),
	(17,'2019-12-29','Xiaomi Mi 9T (tên khác là Redmi K20) là chiếc smartphone vừa được giới thiệu gây rất nhiều chú ý với người dùng bởi nó hội tụ đủ 3 yếu tố "ngon bổ rẻ".
...
Pin đã tốt nay còn tốt hơn' ),
	(19,'2019-12-29','Nếu như từ trước tới nay dòng Galaxy Note của Samsung thường ít được các bạn nữ sử dụng bởi kích thước màn hình khá lớn khiến việc cầm nắm trở nên khó khăn thì Samsung Galaxy Note 10 sẽ là chiếc smartphone nhỏ gọn, phù hợp với cả những bạn có bàn tay nhỏ.
...
Một trong những điểm nhấn đáng quan tâm nhất ở Samsung Galaxy Note 10 chính là cụm camera chất lượng và tiên tiến...' ),
	(20,'2090-12-29','Đặc điểm nổi bật của iPhone 7 32GB
...
Kích thước màn hình 15.6 inch, viền mỏng mở rộng không gian hiển thị.' ),
	(21,'2019-12-30','Đặc điểm nổi bật của Asus VivoBook X409F i5 8265U/8GB/1TB/Win10 (EK138T)
...
Âm thanh SonicMaster sống động'),
	(22,'2019-12-30','Đầy đủ các cổng thông tin 
Laptop có đủ các cổng kết nối thông thường, nổi bật hơn với cổng USB Type-C truyền dữ liệu nhanh chóng.' ),
	(23,'2020-12-30','Acer Aspire A315 54 36QY (NX.HM2SV.001) là chiếc laptop có thiết kế nhỏ gọn, hợp thời trang, màn hình chân thực, sắc nét cùng cấu hình ổn định đáp ứng nhu cầu học tập, làm việc văn phòng. 
...
Laptop được trang bị đầy đủ các cổng kết nối phổ biến như 2 x USB 2.0, USB 3.1, HDMI, LAN (RJ45)' ),
	(1,'2019-12-30','Điện thoại OPPO A5 (2020) có cảm biến vân tay ở mặt lưng' ),
	(2,'2019-12-31','Pin "trâu" hỗ trợ sạc nhanh dung lượng 5.000 mAh. 
...
Trong khi đó, camera selfie của máy có độ phân giải 8 MP cũng hỗ trợ tính năng làm đẹp "ảo diệu", cà da khá mịn và cả xóa phông nữa.' ),
	(24,'2019-12-31','Lenovo IdeaPad 15IKB (81VD0035VN) là mẫu laptop dành cho sinh viên, nhân viên văn phòng với thiết kế hiện đại, trẻ trung và cấu hình sử dụng mượt mà các tác vụ như soạn thảo văn bản, lướt web, nghe nhạc,... 
Cấu hình ổn định 
...
IdeaPad 15IKB (81VD0035VN) có thể sử dụng liên tục khoảng 6 tiếng với độ sáng màn hình tối đa và thực hiện các thao tác như soạn thảo văn bản, nghe nhạc hay mở cùng lúc nhiều tab Chrome,... ' ),
	(21,'2020-12-31','Pin sử dụng cả ngày
Laptop trang bị pin Li-Ion 2 cell có thời gian sử dụng thực tế lên đến 7 - 8 tiếng thoải mái với các tác vụ thông thường sử dụng cả ngày mà không cần sạc pin. ' ),
	(25,'2020-12-31','Laptop Dell Inspiron 5593 với lớp vỏ nhựa cao cấp màu bạc thể hiện sự đẳng cấp sang trọng. Đây là chiếc laptop phù hợp với các bạn học sinh sinh viên đang tìm kiếm một trợ thủ công nghệ đồng hành với mức giá phải chăng.
...
Laptop Dell Inspiron được thiết kế có đến 2 cổng USB 3.1 - thoải mái kết nối với các thiết bị đi kèm. Ngoài ra còn có những cổng thông thường: HDMI, LAN (RJ45), USB 2.0' ),
	(26,'2019-12-31','Đặc điểm nổi bật của Asus VivoBook A412FA i5 8265U/8GB/32GB+512GB/Win10 (EK662T)
...
Viền màn hình siêu mỏng ở cả 4 cạnh kết hợp công nghệ chống chói phủ toàn màn hình giúp mở góc nhìn rộng hơn, tiện lợi khi sử dụng đông người.' ),
	(27,'2019-12-31','Đặc điểm nổi bật của Asus VivoBook X509FJ i7 8565U/8GB/512GB/2GB MX230/Win10 (EJ133T)
...
' ),
	(28,'2020-01-01','Laptop Acer Swift 3 SF315 đáp ứng tất cả các nhu cầu học tập và làm việc cơ bản. Thiết kế mỏng nhẹ giúp bạn có thể di chuyển nhiều nơi một cách dễ dàng. 
...
Mặc dù là chiếc máy mỏng nhẹ, tuy nhiên Laptop Acer Swift SF315 52 50T9 i5 vẫn sở hữu thời lượng pin cực ấn tượng lên đến 10 giờ sử dụng, bạn có thể sử' ),
	(29,'2020-01-01','aptop HP 15s du0115TU i3 (8VB37PA) là mẫu laptop thuộc phân khúc học tập - văn phòng cơ bản. Máy có cấu hình trung bình, thiết kế mỏng nhẹ thanh lịch và ổ cứng SSD siêu nhanh. Laptop đang được bán với giá tốt phù hợp cho học sinh, sinh viên. 
...
Laptop có các cổng giao tiếp: USB 3.1, HDMI, USB Type-C kết nối với tivi, điện thoại,...và các thiết bị khác dễ dàng mà không cần cổng chuyển đổi rườm rà' ),
	(30,'2019-01-01','Laptop Acer Aspire A315 34 C2H9 hướng đến đối tượng học sinh - sinh viên đòi hỏi cấu hình đủ dùng để lướt web, soạn thảo, cùng với đó là mức phải chăng và thiết kế gọn nhẹ. Máy là một trong số ít sản phẩm đảm bảo các yếu tố giá rẻ, thời lượng pin cao cùng ổ cứng SSD nhanh chóng.
...
Laptop Acer có màn hình rộng 15.6 inch kết hợp với viền mỏng cho bạn không gian làm việc, giải trí thoải mái, không phải căng mắt nhìn so với laptop có màn hình 13.3 inch. Chất lượng HD cho độ hiển thị hình ảnh rõ ràng.' ),
	(31,'2020-01-01','Đặc điểm nổi bật của Asus Gaming ROG Strix G531GD i7 9750H/8GB/512GB/4GB GTX1050/Win10 (AL034T)
Bộ sản phẩm chuẩn: Sách hướng dẫn, Thùng máy, Adapter sạc
...
Thời lượng pin của chiếc laptop lên đến 7 giờ sử dụng khi làm việc và giải trí trên MSI GF63 Thin 9SC-070VN mà không cần cắm sạc. Bên cạnh đó, công nghệ sạc nhanh sẽ giúp bạn sẵn sàng trò chơi ở bất kỳ lúc nào.' ),
	(33,'2020-01-02','Laptop Lenovo IdeaPad L340 15IRH i5 (81LK00VTVN) là chiếc laptop gaming gọn nhẹ với hiệu năng cao. Máy được trang bị card đồ họa rời mạnh mẽ và màn hình rộng 15.6 inch cho bạn thỏa sức làm việc, giải trí với các tựa game 3D hiện đại.
...
Máy trang bị đầy đủ các cổng giao tiếp như USB 3.1, HDMI, và USB Type-C cho khả năng kết nối tiện lợi và truy xuất dữ liệu nhanh chóng. Việc gắn thêm chuột và bàn phím rời để chơi game cũng đơn giản hơn với Lenovo IdeaPad L340.' ),
	(34,'2020-01-02','Thế hệ Macbook Pro 2018 đã được ra mắt với nâng cấp mạnh mẽ về cấu hình và khả năng bảo mật với con chip Apple T2. Máy vẫn giữ nguyên các ưu điểm đặc trưng như màn hình siêu nét, thiết kế cao cấp cùng thanh Touch Bar cho khả năng tương tác tuyệt vời với các ứng dụng.
...
Thiết kế cao cấp trên Apple Macbook Pro 2018 13 inch Touchbar MR9Q2SA 
...
Điều này có nghĩa nếu như bạn chỉ dùng để chỉnh sửa ảnh 2D bằng Photoshop, AI thì máy vẫn dư sức đáp ứng. Với các tác vụ thông thường như lướt web, soạn thảo thì CPU tiêu tốn khoảng 10% công suất.
Tương tác thông minh và trực quan hơn với Touch Bar
MacBook Pro 2018 vẫn được trang bị Touch Bar đặc trưng tương tự như mẫu máy năm ngoái, mang lại khả năng tương tác thú vị và tiện lợi hơn trên MacBook. 

Bạn có thể tua nhanh video, sử dụng nhanh các công cụ chỉnh sửa khi xem ảnh. Touch Bar cũng hỗ trợ chuyên sâu cho các ứng dụng đồ họa phổ biến như Photoshop, Premiere Pro... 
...
Cấu hình mạnh mẽ trên Apple Macbook Pro 2018 13 inch Touchbar MR9Q2SA

Tương tác thông minh và trực quan hơn với Touch Bar
MacBook Pro 2018 vẫn được trang bị Touch Bar đặc trưng tương tự như mẫu máy năm ngoái, mang lại khả năng tương tác thú vị và tiện lợi hơn trên MacBook. 

Bạn có thể tua nhanh video, sử dụng nhanh các công cụ chỉnh sửa khi xem ảnh. Touch Bar cũng hỗ trợ chuyên sâu cho các ứng dụng đồ họa phổ biến như Photoshop, Premiere Pro... để hiện ra những công cụ người dùng cần ngay trước mắt.

Touch Bar tiện dụng trên Apple Macbook Pro 2018 13 inch Touchbar MR9Q2SA 
...
Đặc trưng của bàn phím này là hành trình phím trên máy vẫn khá ngắn, bù lại bàn phím lớn và có đèn nền
Máy sở hữu với độ phân giải là 2K, kích thước gọn gàng 13,3 inch. Apple vẫn gọi đây là màn hình Retina, với tấm nền IPS cho góc nhìn rộng và hình ảnh sâu hơn. 
...
Thời lượng pin lên đến 9 tiếng' ),
	(35,'2020-01-02','Cấu hình sử dụng văn phòng mượt mà
...
Công nghệ Acer ComfyView tăng khả năng chống chói cùng tấm nền IPS mang đến góc nhìn rộng, độ tương phản cao, màu sắc trung thực giúp bạn có những trải nghiệm hình ảnh tuyệt vời nhất. ' ),
	(36,'2020-01-02','Đặc điểm nổi bật của Apple MacBook Air 2017 i5 1.8GHz/8GB/128GB (MQD32SA/A)
...
Macbook Air MQD32SA/A i5 5350U cho thời lượng sử dụng lên đến 12 tiếng sau một lần sạc đầy khi sử dụng soạn thảo và lướt web thông thường. ' ),
	(37,'2020-01-02','Laptop Dell Vostro 3580 i3 (V5I3058W) là mẫu laptop học tập văn phòng với thiết kế cứng cáp, chắc chắn, cấu hình vừa phải đáp ứng nhu cầu học tập và giải trí của bạn. 
...
Trên Dell Vostro 3580 i3 còn được tích hợp cảm biến vân tay, bạn dễ dàng mở khóa laptop của mình một cách tiện lợi và an toàn' ),
	(38,'2020-01-02','Laptop ASUS VivoBook X509FJ (EJ227T) là chiếc máy tính xách tay văn phòng giá rẻ nhưng có cấu hình khá, thiết kế đẹp mắt. Máy còn được trang bị cảm biến vân tay mở máy cực nhanh, card đồ họa rời GeForce hiện đại. Đây là một lựa chọn tuyệt vời dành cho giới trẻ. 
...
Thời lượng pin của máy khoảng 3 - 4 giờ. Có thể di chuyển và làm việc thoải mái cả ngày nhờ pin lithium-polymer chất lượng cao có khả năng sử dụng liên tục trong thời gian dài. Công nghệ ASUS Battery Health Charging tăng tuổi thọ cho pin.' ),
	(39,'2020-01-03','Laptop Acer Swift SF114 được trang bị chip Intel Pentium có cấu hình tầm trung, đạt được hiệu năng ổn định với mức giá phải chăng, phù hợp với những bạn học sinh sinh viên đang tìm một trợ thủ đắc lực cùng sánh bước lên giảng đường.
...
Laptop Acer Swift là sự kết hợp của các chuẩn kết nối phổ biến hiện nay, bao gồm: USB 3.0, HDMI, USB 2.0, USB Type-C, dễ dàng kết nối - chia sẻ dữ liệu.' ),
	(1,'2020-01-03','4 camera gấy ấn tượng mạnh, OPPO A5 (2020) còn hỗ trợ tính năng Ultra Night Mode 2.0 giúp chụp ảnh rõ nét trong điều kiện thiếu sáng, quay video 4K cùng khả năng chống rung.
Một điều nữa camera selfie 8 MP tích hợp AI hỗ trợ làm đẹp hứa hẹn mang lại cho các chị em những bức hình lung linh để chia sẻ lên mạng xã hội.' ),
	(3,'2020-01-03','Thêm tính năng quay video slow motion dành cho camera trước
Ram lên thành 4 GB, iOS 13 , mọi thao tác trên iPhone mới rất mượt, khả năng chống nước tốt hơn,thời lượng pin trâu hơn 1 giờ so với chiếc iPhone Xr.' ),
	(21,'2019-01-06','Với Asus VivoBook X409F, Asus mang đến công nghệ âm thanh SonicMaster độc quyền đem lại âm thanh to rõ, sống động để bạn có được trải nghiệm nghe tốt nhất.
...
Nhằm đem lại độ bảo mật hiệu quả cho các dữ liệu mật của bạn, Asus trang bị cảm biến vân tay giúp mở máy nhanh, bảo mật an toàn.' ),
	(22,'2020-01-05','Laptop có thời lượng pin thực tế khoảng 5 giờ
